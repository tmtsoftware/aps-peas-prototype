...
and writes it to peas-procedure-setup-service/src/main/resources/sequences/testmode.json.

Run from the aps-peas-prototype project root:
...
out_dir = os.path.join(os.path.dirname(__file__), '..',
                       'peas-procedure-setup-service', 'src', 'main', 'resources', 'sequences')
