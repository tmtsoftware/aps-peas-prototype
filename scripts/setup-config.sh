...
SEQ_DIR="peas-procedure-setup-service/src/main/resources/sequences"
...
# ---------------------------------------------------------------------------
# Session start sequences
# ---------------------------------------------------------------------------

upload_config \
  "peas-procedure-setup-service/src/main/resources/sequences/ics-home-all.json" \
  "/aps/sequences/ics-home-all.json" \
  "APS ICS Sequencer homeMechanisms sequence"

upload_config \
  "peas-procedure-setup-service/src/main/resources/sequences/ics-set-operating-mode.json" \
  "/aps/sequences/ics-set-operating-mode.json" \
  "APS ICS Sequencer setOperatingMode sequence"
