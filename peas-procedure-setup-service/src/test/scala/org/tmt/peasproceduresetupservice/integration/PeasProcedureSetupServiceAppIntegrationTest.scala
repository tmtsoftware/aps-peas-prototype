package org.tmt.peasproceduresetupservice.integration
...
import org.tmt.peasproceduresetupservice.impl.PeasProcedureSetupServiceWiring
import org.tmt.peasproceduresetupservice.core.models.{AdminGreetResponse, GreetResponse, UserInfo}
import org.tmt.peasproceduresetupservice.http.HttpCodecs

import scala.compiletime.uninitialized
import scala.concurrent.duration.DurationInt
import scala.concurrent.{Await, ExecutionContext}

class PeasProcedureSetupServiceAppIntegrationTest extends ScalaTestFrameworkTestKit with AnyWordSpecLike with Matchers with HttpCodecs {
  ...
  val apsSubmitterPrototypeWiring                     = new PeasProcedureSetupServiceWiring(Some(apsSubmitterPrototypeAppPort))
  ...
  "PeasProcedureSetupServiceWiring" must {
